...
export default function Sidebar({ user }: { user: User }) {
  ...
  const accentBg    = isDev ? "rgba(124,107,196,0.09)" : "rgba(233,160,32,0.10)";
  ...
  return (
    <aside
      ...
      style={{
        ...
        borderRight:  "1px solid rgba(124,107,196,0.12)",
        backdropFilter: "blur(20px)",
        boxShadow:    "2px 0 16px rgba(108,99,183,0.06)",
      }}
    >
      {/* Logo */}
      <div className="px-5 py-5 border-b" style={{ borderColor: "rgba(124,107,196,0.10)" }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-bold text-sm leading-none" style={{ color: "#1E1B3A" }}>TeamPulse</p>
      ...
      {/* User block */}
      <div className="px-3 py-4 border-t" style={{ borderColor: "rgba(124,107,196,0.10)" }}>
        <div className="flex items-center gap-3 px-2 mb-3">
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold truncate" style={{ color: "#1E1B3A" }}>{user.name}</p>
            <p className="text-xs truncate" style={{ color: "#9896B5" }}>{user.email}</p>
          </div>
        </div>
        <button
